...
movie_model: Model = api.model('Фильм', {
    ...
    'trailer': fields.String(max_length=200, example='Фантастика'),
...
director_model: Model = api.model('Режиссёр', {
    'id': fields.Integer(required=True, example=1),
    'name': fields.String(required=True, max_length=100, example='Джордж Лукас')
})
user_model: Model = api.model('Пользователь', {
    'id': fields.Integer(required=True, example=1),
    'email': fields.String(required=True, max_length=200, example='user@email.ru'),
